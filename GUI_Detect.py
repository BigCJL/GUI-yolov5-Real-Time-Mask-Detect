# -*- coding: utf-8 -*-
# @Time     : 2021-07-30 20:23
# @Author   : Big Cheng
# @FileName : GUI_Detect_1.0.py
# -*- coding: utf-8 -*-
...
# 访问res文件夹下数据.txt的内容
model = resource_path(os.path.join("res", "best_320_s.onnx"))
background_img = resource_path(os.path.join("res", "background.jpg"))   # 这里巨坑，好像是前端css不支持\\的路径
background_img = eval(repr(background_img).replace(r'\\', '/'))
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("#MainWindow{border-image:url(" + background_img + ")}")
        # MainWindow.setStyleSheet("#MainWindow{border-image:url(res/background.jpg)}")
        ...
        self.pushButton_img.setMinimumSize(QtCore.QSize(120, 80))
        self.pushButton_img.setMaximumSize(QtCore.QSize(120, 80))
        font = QtGui.QFont()
        ...
        self.pushButton_camera.setMinimumSize(QtCore.QSize(120, 80))
        self.pushButton_camera.setMaximumSize(QtCore.QSize(120, 80))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.pushButton_video.setMinimumSize(QtCore.QSize(120, 80))
        self.pushButton_video.setMaximumSize(QtCore.QSize(120, 80))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Mask Face Detect"))
